        ...
        {week.map((day) => {
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 rounded-ios px-3 py-3 text-left transition-all duration-200 ease-spring-soft ${
            ...
            >
              <div className="flex w-11 shrink-0 flex-col items-center">
                ...
                <span
                  className={`mt-0.5 grid h-8 w-8 place-items-center rounded-full text-[15px] font-sf ${
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-1 pt-0.5">
                {dayItems.length === 0 ? (
                  <span className="text-[13px] text-ink-soft/60">일정 없음</span>
                ) : (
